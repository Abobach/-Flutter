...
import 'package:diplom_flutter/phoneAyth/utils.dart';
...
class _UserInfromationScreenState extends State<UserInfromationScreen> {
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            textFeld(
                              hintText:
                                  "Расскажите кратко где бывали в городе Волоколамск",
                              icon: Icons.edit,
                              inputType: TextInputType.name,
                              maxLines: 2,
  ...
  Widget textFeld({
    ...
    return Padding(
      ...
      child: TextFormField(
        cursorColor: Color.fromRGBO(29, 65, 53, 1),
  ...
  void storeData() async {
    ...
    if (image != null) {
      ...
      showSnackBar(context, "Пожалуйста добавьте фото");
    }
  }
}
